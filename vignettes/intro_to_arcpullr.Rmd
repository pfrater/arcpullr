...
functions provide the basis for querying data housed in a spatial REST
API in both a spatial and relational manner.
...
This function is the core of the package, and allows users to pull data
...
and format it to an object of class sf (*i.e.* of the R package sf:
...
that removes the abstraction of the spatial query syntax query by
